...
abstract external class EOperationBase : ETypedElementImpl, EOperation {
    open var _eTypeParameters: Any
    open var _eParameters: Any
    open var _eExceptions: Any
    open var _eGenericExceptions: Any
    override fun isOverrideOf(someOperation: EOperation): Boolean
    override fun getOperationID(): Number
