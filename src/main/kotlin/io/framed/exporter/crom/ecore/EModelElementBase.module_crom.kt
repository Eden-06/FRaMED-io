...
abstract external class EModelElementBase : BasicEObjectImpl, EModelElement {
    open var _eAnnotations: Any
    override fun getEAnnotation(source: String): EAnnotation
