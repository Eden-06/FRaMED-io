...
abstract external class EParameterBase : ETypedElementImpl, EParameter {
    ...
    open fun basicSetEOperation(newobj: EOperation, msgs: NotificationChain): NotificationChain
