...
class CreateRelationshipLinker(
    ...
    override val sidebar = sidebar {
        title("Create io.framed.exporter.crom.Relationship")
    ...
    companion object : LinkerInfoConnection {
        override val info = ElementInfo("Create io.framed.exporter.crom.Relationship", FramedIcon.EVENTRELATIONSHIP)
