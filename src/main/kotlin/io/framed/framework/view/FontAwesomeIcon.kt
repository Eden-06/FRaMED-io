...
enum class FontAwesomeIcon(private val ligature: String) : Icon {
    ...
    FILE("project"),
    FILE_ALT("project-alt"),
    FILE_ARCHIVE("project-archive"),
    FILE_AUDIO("project-audio"),
    FILE_CODE("project-code"),
    FILE_CONTRACT("project-contract"),
    FILE_CSV("project-csv"),
    FILE_DOWNLOAD("project-download"),
    FILE_EXCEL("project-excel"),
    FILE_EXPORT("project-export"),
    FILE_IMAGE("project-image"),
    FILE_IMPORT("project-import"),
    FILE_INVOICE("project-invoice"),
    FILE_INVOICE_DOLLAR("project-invoice-dollar"),
    FILE_MEDICAL("project-medical"),
    FILE_MEDICAL_ALT("project-medical-alt"),
    FILE_PDF("project-pdf"),
    FILE_POWERPOINT("project-powerpoint"),
    FILE_PRESCRIPTION("project-prescription"),
    FILE_SIGNATURE("project-signature"),
    FILE_UPLOAD("project-upload"),
    FILE_VIDEO("project-video"),
    FILE_WORD("project-word"),
    FILL("fill"),
    FILL_DRIP("fill-drip"),
    FILM("film"),
    FILTER("filter"),
