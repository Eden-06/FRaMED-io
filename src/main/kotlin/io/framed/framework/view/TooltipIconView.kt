...
/**
 * Represents a icon with a hovering textual tooltip.
 *
...
class TooltipIconView(
    ...
    constructor(
        iconProperty: ReadOnlyProperty<out Icon?>,
    ...
    private val inactiveProperty by ClassDelegate()
    ...
    var toolTipText: TooltipTextView = TooltipTextView(toolTipText)
        set(value) {
            ...
            icon?.let { html.appendChild(it.element) }
        }
...
fun ViewCollection<in TooltipIconView, *>.tooltipIconView(
    icon: Icon? = null,
    toolTipText: String = "",
    init: TooltipIconView.() -> Unit = {}
) =
